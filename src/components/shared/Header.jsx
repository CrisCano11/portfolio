            ...
            <div className="z-10 max-w-screen-lg xl:max-w-screen-xl block sm:flex sm:justify-between sm:items-center py-6">
                <div className="flex justify-between items-center px-4 sm:px-0">
                    ...
                    >
                        {activeTheme === 'dark' ? (
                            ...
                            <FiSun className="text-grey-200 hover:text-gray-50 text-xl" />
                        )}
                    </div>
                ...
                >
                    ...
                    <NavLink
                        ...
                        aria-label="Contact"
                    />
                    <div className="border-t-2 pt-3 sm:pt-0 sm:border-t-o border-primary-light dark:border-secondary-dark">
                        <span
                            onClick={showModalHire}
                            className="font-general-medium sm:hidden block text-left text-md bg-indigo-500 hover:bg-indigo-600 text-white shadow-sm rounden-sm px-4 py-2 mt-2 duration-300 w-24"
                            aria-label="Hire Me"
                        >
